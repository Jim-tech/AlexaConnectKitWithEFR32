...
const pb_field_t acp_response_get_ack_status_fields[10] = {
    ...
    PB_FIELD(  8, UENUM   , SINGULAR, STATIC  , OTHER, acp_response_get_ack_status, wifi_disconnection_reason, epoch_seconds, 0),
    PB_FIELD(  9, BOOL    , SINGULAR, STATIC  , OTHER, acp_response_get_ack_status, is_distress_beaconing, wifi_disconnection_reason, 0),
    PB_LAST_FIELD
};
