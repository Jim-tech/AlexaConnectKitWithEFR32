...
#include "ack_generated_alexa_cooking_food_temperature_sensor.h"
    ...
    float temperature)
{
    ...
    result = AddPropertyToEventDocument(
        pCommon,
        ack_namespace_alexa_cooking_food_temperature_sensor,
        NULL, // No instance for this capability
        ack_alexa_cooking_food_temperature_sensor_property_name_food_temperature,
        &propertyObject)
