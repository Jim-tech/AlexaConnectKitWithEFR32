...
/* Generated by nanopb-0.3.9 at Mon Nov  2 15:13:33 2020. */
...
typedef enum _acp_wifi_disconnection_reason {
    acp_wifi_disconnection_reason_unknown = 0,
    acp_wifi_disconnection_reason_ssid_not_found = 1,
    acp_wifi_disconnection_reason_incorrect_psk = 2
} acp_wifi_disconnection_reason;
#define _acp_wifi_disconnection_reason_MIN acp_wifi_disconnection_reason_unknown
#define _acp_wifi_disconnection_reason_MAX acp_wifi_disconnection_reason_incorrect_psk
#define _acp_wifi_disconnection_reason_ARRAYSIZE ((acp_wifi_disconnection_reason)(acp_wifi_disconnection_reason_incorrect_psk+1))
...
typedef struct _acp_response_get_ack_status {
    ...
    acp_wifi_disconnection_reason wifi_disconnection_reason;
    bool is_distress_beaconing;
...
#define acp_response_get_ack_status_init_default {acp_time_init_default, (acp_wifi_mode)0, 0, (acp_response_error_codes)0, 0, (acp_setup_stages)0, 0, (acp_wifi_disconnection_reason)0, 0}
...
#define acp_response_get_ack_status_init_zero    {acp_time_init_zero, (acp_wifi_mode)0, 0, (acp_response_error_codes)0, 0, (acp_setup_stages)0, 0, (acp_wifi_disconnection_reason)0, 0}
...
#define acp_response_get_ack_status_wifi_disconnection_reason_tag 8
#define acp_response_get_ack_status_is_distress_beaconing_tag 9
...
extern const pb_field_t acp_response_get_ack_status_fields[10];
...
#define acp_response_get_ack_status_size         59
