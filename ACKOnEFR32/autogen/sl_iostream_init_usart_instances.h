...
extern sl_iostream_t *sl_iostream_ack_handle;
extern sl_iostream_uart_t *sl_iostream_uart_ack_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_ack_info;
